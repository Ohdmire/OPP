...
export function GameSessionPage() {
  ...
  const launch = async () => { setBusy(true); setError(null); try { setSession(await desktopApi.startGameSession(ruleset, client)); } catch (value) { setError(value); } finally { setBusy(false); } };
  return <>
